create schema bank;
use bank;
create table deposit(name varchar(100) , gender char(2), age int(50), amount bigint);
...
/*ladies and seniorcitizen-8.75%)*/
select name,amount,(amount*0.0875)/4 as intrestgained ,sum(amount + (amount*0.875/4)) as totalamount from deposit where gender='F AND age>=60';